...
await page.evaluate(()=>{const S=window.MAQ.state;S.supplier='RENALIA';S.lines=[
  {id:'L1',name:'Feeder',dn:100,bar:12,pts:[[60,15],[67,90]],specials:[],parent:null},
  {id:'L2',name:'Antenne',dn:80,bar:12,pts:[[63.7,55],[35,58]],specials:[],parent:{line:'L1',m:40,side:-1}}];S.seq=3;window.MAQ.setMode('select');window.MAQ.rebuild();});
...
await page.evaluate(()=>{const T=window.TRACE;const L2=Object.values(T.lines).find(l=>l.parent);L2.cond.A.joints[0].tee={mode:'serie',wire:'E'};T.centerOn(62.5,55.4,150);T.renderAll();});
